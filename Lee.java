...
/*
 Находим наименьший путь между стартом и целью
...
public Lee() {
    ...
    //matrix[1][0]=OBSTACLE(препятствие); matrixVisited[1][0]=true; нет пути
...
/*
 Первое
  ...
  обозначить всеъ немаркированных соседей точек , которые обозначены с i с помощью i+1
 */
...
/*
 Second step
  ...
  С целевого узла идем к следующему узлу, которое имеет меньшее обозначение, чем текущий узел
  Добавляем этот узел к пути, пока не достигнут стартовый узел
 */
...
/*
  Находим соседа узла с наименьшим значением матрицы для перетасовки
 */
